...
public class ScoresProvider extends ContentProvider {
    ...
    public static final String BROADCAST_INTENT = DatabaseContract.CONTENT_AUTHORITY + ".ACTION_DATA_UPDATED";
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        switch (match_uri(uri)) {
            case MATCHES:
                ...
                Intent updated = new Intent(BROADCAST_INTENT).setPackage(getContext().getPackageName());
                getContext().sendBroadcast(updated);
